package GeoMath2D.SIDED;//package com.SIDED;
...
//    public void PythagoreanTheoremSolveForA(double b, double c) {
//        if((b < 1 || c < 1)) {
...
//        System.out.println("Your value of b in the Pythagorean Theorem is = " + String.format("%.2f", b));
//    }
//
//    public void PythagoreanTheoremSolveForC(double a, double b) {
//        if((a < 1) || (b < 1)) {
//            System.out.println(INVALID_VALUE_ENTERED);
//        }
//        double cHyp = Math.sqrt(((a*a) + (b*b)));
