...
public class ShapeAssets {
    ...
    //Triangles
    public void typeOfTriangle(double sideOne, double sideTwo, double sideThree) {
    ...
    public void trianglePerimeter(double side1, double side2, double side3) {
    ...
    public void radiusFromArea(double area) {
        if(area < 1) {
            System.out.println(INVALID_VALUE_ENTERED);
        }
