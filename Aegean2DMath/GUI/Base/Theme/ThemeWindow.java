package Aegean2DMath.GUI.Base.Theme;
...
//            BottomGUI.calculateAreaButton.setForeground(ColorVar.Midnight_Gray); //todo
...
//            ColorPalettePanel.openColorChooser.setBackground(ColorVar.Variety_Aqua_Navy_Blue);
        ...
        if(chooseThemeComboBox.getSelectedItem() == themes[2]) {
            ...
            BottomGUI.DimensionPanel.setBorder(BorderFactory.createLineBorder(ColorVar.Black, 2));
            BottomGUI.LengthPanel.setBackground(ColorVar.Misty_blue);
            BottomGUI.LengthPanel.setBorder(BorderFactory.createLineBorder(ColorVar.Black, 2));
            BottomGUI.WidthPanel.setBackground(ColorVar.Misty_blue);
            BottomGUI.WidthPanel.setBorder(BorderFactory.createLineBorder(ColorVar.Black, 2));
            ...
            BottomGUI.CalcAreaPanel.setBorder(BorderFactory.createLineBorder(ColorVar.Black, 2));
            BottomGUI.CalcPCPanel.setBackground(ColorVar.Misty_blue);
            BottomGUI.CalcPCPanel.setBorder(BorderFactory.createLineBorder(ColorVar.Black, 2));
        ...
        if (chooseThemeComboBox.getSelectedItem() == themes[3]) {
            ...
            SideGUI.CalculatorButton.setBackground(ColorVar.Variety_Deep_Magenta);
            SideGUI.CalculatorButton.setForeground(ColorVar.Variety_BLACK);
            SideGUI.formulaPanel.setBackground(ColorVar.Variety_Bottle_Green);
            SideGUI.formulaPanel.setBorder(BorderFactory.createLineBorder(ColorVar.Variety_WHITE, 2));
            SideGUI.TriangleRbtn.setBackground(ColorVar.Variety_BLACK);
            SideGUI.TriangleRbtn.setForeground(ColorVar.Variety_WHITE);
        ...
        if(chooseThemeComboBox.getSelectedItem() == themes[4]) {
            ...
            BottomGUI.DimensionPanel.setBorder(BorderFactory.createLineBorder(ColorVar.Sunset_Gray, 2));
            BottomGUI.LengthPanel.setBackground(ColorVar.Sunset_Gray);
            BottomGUI.LengthPanel.setBorder(BorderFactory.createLineBorder(ColorVar.Sunset_Gray, 2));
            BottomGUI.WidthPanel.setBackground(ColorVar.Sunset_Gray);
            BottomGUI.WidthPanel.setBorder(BorderFactory.createLineBorder(ColorVar.Sunset_Gray, 2));
            ...
            BottomGUI.CalcAreaPanel.setBorder(BorderFactory.createLineBorder(ColorVar.Sunset_Gray, 2));
            BottomGUI.CalcPCPanel.setBackground(ColorVar.Sunset_Gray);
            BottomGUI.CalcPCPanel.setBorder(BorderFactory.createLineBorder(ColorVar.Sunset_Gray, 2));
