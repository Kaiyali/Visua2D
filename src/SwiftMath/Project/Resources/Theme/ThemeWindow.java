package SwiftMath.Project.Resources.Theme;

import SwiftMath.Project.Resources.ComponentAssets.AppColors;
...
import SwiftMath.Project.GUI.SystemManager.Application;
...
public class ThemeWindow extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(chooseThemeComboBox.getSelectedItem() == themes[1]) {
            ...
            SideGUI.CircleButton.setBackground(AppColors.Midnight_Gray);
            SideGUI.CircleButton.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
            SideGUI.CircleButton.setForeground(AppColors.Variety_WHITE);
            ...
            SideGUI.CircleRbtn.setForeground(AppColors.Variety_WHITE);
        ...
        if(chooseThemeComboBox.getSelectedItem() == themes[2]) {
            ...
            SideGUI.CircleButton.setBackground(AppColors.Cool_Gray);
            SideGUI.CircleButton.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
            SideGUI.CircleButton.setForeground(AppColors.White);
            ...
            SideGUI.CircleRbtn.setBackground(AppColors.White);
            SideGUI.CircleRbtn.setForeground(AppColors.White);
        ...
        if (chooseThemeComboBox.getSelectedItem() == themes[3]) {
            ...
            SideGUI.CircleButton.setBackground(AppColors.Variety_Pink);
            SideGUI.CircleButton.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
            SideGUI.CircleButton.setForeground(AppColors.Variety_BLACK);
        ...
        if(chooseThemeComboBox.getSelectedItem() == themes[4]) {
            ...
            SideGUI.CircleButton.setBackground(AppColors.Mimosa);
            SideGUI.CircleButton.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
