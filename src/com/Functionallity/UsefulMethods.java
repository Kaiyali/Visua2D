...
public class UsefulMethods {
    ...
    //Triangles
    public static void typeOfTriangle(double sideOne, double sideTwo, double sideThree) {
    ...
    public static void radiusFromArea(double area) {
        if(area < 1) {
            System.out.println(INVALID_VALUE_ENTERED);
        }
    ...
    public static void radiusFromCircumference(double circumference) {
        if(circumference < 1) {
            System.out.println(INVALID_VALUE_ENTERED);
        }
